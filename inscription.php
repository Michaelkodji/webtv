    ...
    <main>
        ...
        <div class="wrapper wrapper--w680" >
            <div class="card card-1" id="bk">
                ...
                <div class="card-body">
                    <h2 class="title">Entrer votre numéro matricule</h2>

                    <form method="post" action="index.php?controller=control_signin">
                            <input type="text" name="id" placeholder="numero d'inscription" max="10" required><br><br>
                            <input class="btn btn--radius btn--green" type="submit" name="validation" value="valider">
                        </div>
                        </div>
